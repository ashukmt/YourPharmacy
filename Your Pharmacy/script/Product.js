...
const Random_Fetch = async () => {
  try {
    ...
    let P_Resp = await fetch(`https://ill-jade-chiton.cyclic.cloud/Random?_page=${page}&_limit=15`);
...
async function fetch_Supp(){
    try {
        ...
        let Su_Resp = await fetch(`https://ill-jade-chiton.cyclic.cloud/Suppliment?_page=${page}&_limit=15`);
...
async function Eye_C(){
    try {
        ...
        let EC_Resp = await fetch(`https://ill-jade-chiton.cyclic.cloud/Eye_Care?_page=${page}&_limit=15`);
...
async function Fetch_Brand() {
    ...
    //  console.log(city);
    let res = await fetch(`https://ill-jade-chiton.cyclic.cloud/Brand`)
...
async function Debouncing(){
  ...
  let res=await fetch(`https://ill-jade-chiton.cyclic.cloud/Brand?q=${city_name}`)
  let data=await res.json();
...
async function Search_Brand(query){
  try {
    ...
    let P_Resp = await fetch(`https://ill-jade-chiton.cyclic.cloud/Random?_page=${page}&_limit=15&q=${query}`);
    let P_Data = await P_Resp.json();
